...
## Components
**Status:** v0.1.1 shipped. v0.2.0 feature-complete: all 10 new primitives + 6 recipe pages live under `/recipes/*` (Profile, Job, Charity, Listing, Esports, Podcast). Recipes nav group added; "Recipes" link wired into top navbar/mobile drawer. `NbText` directive added (typography layer).
**Next:** Visual QA pass on each recipe page, then cut v0.2.0 release. Add NbText docs page.
