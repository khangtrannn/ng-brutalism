...
import { NbHalftone, NbStat, NbSurface } from '@ng-brutalism/ui';
    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        <div class="mb-5">
          ...
          <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
            A decorative dot-grid component that anchors to card corners via
            absolute positioning or renders as a clean rectangular strip. The
            classic halftone pattern borrowed from print design adds depth and
            texture to brutalist cards without cluttering the layout.
          </p>
        </div>
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3">
          ...
          <div
            ...
            class="items-start"
          >
            <nb-stat value="CSS" label="Rectangle strip" />
          </div>
      ...
      <section id="usage">
        ...
        <p class="mb-4 font-medium">
          ...
          <code class="font-mono">relative overflow-hidden</code> container.
          Position it with Tailwind classes (<code class="font-mono"
            >absolute</code
          >, <code class="font-mono">top-*</code>,
          <code class="font-mono">right-*</code>, etc). The component is
          decorative (<code class="font-mono">aria-hidden="true"</code>).
        </p>
        <docs-code-block
          class="block mb-5"
          title="Import"
      ...
      <section id="rectangle">
        ...
        <p class="mb-4 max-w-3xl font-medium">
          Use rectangle halftone as a decorative strip behind headings, badges,
          image cards, recipe accents, and banner edges. Rows and columns give
          you a predictable dot count, while size and gap inputs tune the visual
          rhythm.
        </p>
      ...
      <section id="accessibility">
        ...
        <p class="font-medium">
          <strong>APG pattern:</strong> N/A - Halftone is a decorative,
          presentational dot-grid accent hidden from assistive tech, not an
          ...
          <table class="w-full min-w-160 border-collapse text-left">
            ...
            <tbody class="font-medium">
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Visual shape. Rectangle renders a CSS background strip.
                </td>
              </tr>
              <tr class="border-b-2 border-(--nb-border)">
                <td
              ...
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Gap between dots in px. Rectangle strips use this as both axes
                  unless gapX or gapY is set.
                </td>
              </tr>
              <tr class="border-b-2 border-(--nb-border)">
                <td
                ...
                <td class="px-4 py-3">
                  Horizontal rectangle dot rhythm in px.
                </td>
              </tr>
              <tr>
                <td
