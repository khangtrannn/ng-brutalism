...
import { NbDisplay, NbStat, NbSurface } from '@ng-brutalism/ui';
    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3">
          ...
          <div
            ...
            class="items-start"
          >
            <nb-stat value="any" label="Host element" />
          </div>
          <div
            nbSurface
            tone="mint"
            ...
            class="items-start"
          >
            <nb-stat value="4" label="Display scale" />
          </div>
          <div
            nbSurface
            tone="pink"
            ...
            class="items-start"
          >
            <nb-stat value="7" label="CSS variables" />
          </div>
      ...
      <section id="custom-size">
        ...
        <p class="mb-4 font-medium">
          Override <code class="font-mono">--nb-display-size</code> inline for
          any arbitrary value outside the 4 presets.
        </p>
      ...
      <section id="underline">
        ...
        <docs-example [code]="underlineExampleCode">
          <div class="flex flex-col gap-8">
            <h2 nbDisplay size="lg" underline="bar" class="uppercase">
              SHIP IT
            </h2>
            <h2 nbDisplay size="lg" underline="wave" class="uppercase">
              STAY SHARP
            </h2>
            <h2
              nbDisplay
      ...
      <section id="accessibility">
        ...
        <p class="font-medium">
          <strong>APG pattern:</strong> N/A - Display is a static,
          presentational typography directive for oversized text, not an
          ...
          <table class="w-full min-w-160 border-collapse text-left">
            ...
            <tbody class="font-medium">
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Controls font size via
                  <code class="font-mono">--nb-display-size</code>.
                </td>
              </tr>
              <tr>
                <td
                ...
                <td class="px-4 py-3">
                  Draws a built-in accent underline beneath the text. Style it
                  with the
