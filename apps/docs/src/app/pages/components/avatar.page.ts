...
import { NbAvatar, NbStat, NbSurface } from '@ng-brutalism/ui';
    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3">
          ...
          <div
            ...
            class="items-start"
          >
            <nb-stat value="IMG" label="or Text" />
          </div>
      ...
      <section id="preview">
        ...
        <docs-example [code]="defaultExampleCode">
          <nb-avatar
            class="h-20 w-20"
            src="https://github.com/khangtrannn.png"
            alt="khangtrannn"
          />
        </docs-example>
      </section>
      ...
      <section id="accessibility">
        ...
        <p class="font-medium">
          <strong>APG pattern:</strong> N/A - Avatar is static, presentational
          content that renders a user's image or initials fallback, not an
