...
import { NbCheckbox, NbLabel, NbStat, NbSurface } from '@ng-brutalism/ui';
    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        <div class="mb-5">
          ...
          <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
            The neo-brutalist Angular Checkbox component. A control that allows
            the user to toggle between checked and not checked in the brutalist
            style with strong focus states.
          </p>
        </div>
      ...
      <section id="preview">
        ...
        <docs-example [code]="defaultExampleCode">
          <input type="checkbox" nbCheckbox aria-label="Demo checkbox" />
        </docs-example>
      </section>
      ...
      <section id="sizes">
        ...
        <docs-example [code]="sizesExampleCode">
          <div class="flex items-center gap-4">
            ...
            />
            <input type="checkbox" nbCheckbox aria-label="Default checkbox" />
            <input
              type="checkbox"
              nbCheckbox
              size="lg"
      ...
      <section id="accessibility">
        ...
        <p class="font-medium">
          ...
          <code class="font-mono">[(ngModel)]</code> binding all come from the
          browser and Angular's built-in
          <code class="font-mono">DefaultValueAccessor</code> - no custom ARIA
          state to keep in sync. Pair it with
          <code class="font-mono">nbLabel</code> (or wrap both in
          <a routerLink="/components/field" class="underline">nb-field</a>) so
