    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        <div class="mb-5">
          ...
          <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
            An accessibility-wiring primitive, not a visual one. Wrap a label, a
            control (<code class="font-mono">nbInput</code>,
            ...
            reading state straight off the bound
            <code class="font-mono">NgControl</code>.
          </p>
        </div>
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3">
          ...
          <div
            ...
            class="items-start"
          >
            <nb-stat value="FORM" label="Reactive Forms" />
          </div>
          <div
            nbSurface
            tone="pink"
            ...
            class="items-start"
          >
            <nb-stat value="A11Y" label="Id wiring" />
          </div>
      ...
      <section id="usage">
        ...
        <p class="mb-4 font-medium">
          ...
          <code class="font-mono">formControlName</code>) to any control inside
          <code class="font-mono">nb-field</code> - the field reads the
          control's touched/dirty/invalid/required status straight off it, no
          separate error-state input to keep in sync.
        </p>
        <docs-code-block
          class="block mb-5"
          title="Import"
      ...
      <section id="invalid-state">
        ...
        <p class="mb-4 font-medium">
          <code class="font-mono">nb-field-error</code> stays hidden until the
          control is both touched and invalid - so validation errors never
          appear before the user has had a chance to interact with the field.
        </p>
      ...
      <section id="accessibility">
        ...
        <p class="mb-4 font-medium">
          <code class="font-mono">nb-field</code> is not itself an interactive
          widget, so it has no APG pattern of its own - it implements the
          underlying
          <a
        ...
        <div nbStack gap="md" class="mb-6">
          <div nbCallout tone="mint" size="sm">
            <strong>Label linking</strong> -
            <code class="font-mono">nbLabel</code> reads
            <code class="font-mono">nb-field</code>'s generated
          ...
          <div nbCallout tone="yellow" size="sm">
            <strong>Description + error linking</strong> - the description's id
            is in <code class="font-mono">aria-describedby</code> immediately;
            the error's id is appended only once the control is both touched and
            invalid, and <code class="font-mono">aria-invalid</code>
            flips at the same moment.
          </div>
          <div nbCallout tone="pink" size="sm">
            <strong>Required</strong> -
            <code class="font-mono">aria-required</code> is derived from a
            <code class="font-mono">Validators.required</code>
        ...
        <p class="text-sm opacity-70">
          ...
          valid and touched+invalid states - see
          <code class="font-mono">nb-field.spec.ts</code>.
        </p>
      </section>
          ...
          <table class="w-full min-w-160 border-collapse text-left">
            ...
            <tbody class="font-medium">
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Context host. Generates
                  <code class="font-mono">controlId</code> and computed
                  <code class="font-mono">describedBy</code>/
                  <code class="font-mono">invalid</code>/<code class="font-mono"
                    >required</code
                  >
                  from the projected <code class="font-mono">NgControl</code>.
                  Reflects <code class="font-mono">[data-invalid]</code> on
                  itself.
                </td>
              </tr>
              <tr class="border-b-2 border-(--nb-border)">
