...
import { NbIconButton, NbStat, NbSurface } from '@ng-brutalism/ui';
    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        <div class="mb-5">
          ...
          <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
            A <code class="font-mono">&lt;button&gt;</code> for icon-only
            actions. Supports square and circle shapes, 4 sizes, tunable corner
            radius, and the shared <code class="font-mono">tone</code> color
            palette. Pass an <code class="font-mono">icon</code> URL to render
            it internally, or project your own
            <code class="font-mono">&lt;svg&gt;</code> via
        ...
        <div class="mt-7 flex flex-wrap items-center gap-3">
          ...
          <div
            ...
            class="items-start"
          >
            <nb-stat value="button" label="Host element" />
          </div>
          <div
            nbSurface
            tone="mint"
      ...
      <section id="accessibility">
        ...
        <p class="font-medium">
          ...
          <code class="font-mono">&lt;button&gt;</code>, so activation and focus
          come from native HTML. Because it's icon-only, there's no visible text
          to supply the accessible name - always set
          <code class="font-mono">aria-label</code> (every example on this page
          does).
        </p>
      </section>
          ...
          <table class="w-full min-w-160 border-collapse text-left">
            ...
            <tbody class="font-medium">
              ...
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Corner radius for square buttons. Ignored when shape is
                  'circle'.
                </td>
              </tr>
              <tr class="border-b-2 border-(--nb-border)">
              ...
              <tr class="border-b-2 border-(--nb-border)">
                ...
                <td class="px-4 py-3">
                  Outline strength - writes the border width.
                </td>
              </tr>
              <tr>
                <td
                ...
                <td class="px-4 py-3">
                  SVG/image URL rendered internally via nbIcon (mask mode, sized
                  to the button). Omit to project your own icon.
                </td>
              </tr>
            </tbody>
          </table>
