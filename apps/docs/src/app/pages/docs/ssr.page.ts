    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        <div class="mb-5">
          ...
          <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
            ng-brutalism has no browser-only assumptions in its core
            primitives, works under zoneless change detection, and generates
            ids through an injectable counter so server-rendered markup
      ...
      <section id="id-generation">
        ...
        <p class="mb-4 font-medium">
          Components that generate ids for ARIA wiring (<code class="font-mono">nb-select</code>,
          <code class="font-mono">nb-field</code> and its description/error
          directives, accordion triggers...) pull a counter from an
          injectable <code class="font-mono">NbIdGenerator</code> rather than
      ...
      <section id="zoneless">
        ...
        <p class="font-medium">
          ...
          <code class="font-mono">ChangeDetectionStrategy.OnPush</code>, with
          no reliance on <code class="font-mono">zone.js</code> patching for
          state updates to be picked up. This docs site itself runs zoneless,
