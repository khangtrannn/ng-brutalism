    ...
    <article>
      ...
      <section id="hero-split" class="scroll-mt-32">
        ...
        <p class="mb-6 text-base font-medium">
          A wide main area paired with a narrower aside - a typical hero layout.
          The aside stacks below on small screens when
      ...
      <section id="media-content" class="scroll-mt-32">
        ...
        <p class="mb-6 text-base font-medium">
          Equal columns - a media placeholder on the left and rich content on
          the right. Classic recipe card or feature block pattern.
        </p>
        ...
        <docs-example [code]="mediaContentCode">
          <section nbSplit ratio="1:1" gap="lg" collapse="md" class="w-full">
            ...
            <div nbStack gap="md">
              ...
              <p nbText tone="muted">
                Use split layouts for visual/content compositions. The left side
                holds an image or media frame; the right holds structured
                content.
              </p>
