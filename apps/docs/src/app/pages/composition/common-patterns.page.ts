    ...
    <article>
      <header id="overview" class="relative mb-10 scroll-mt-32">
        ...
        <p class="mt-3 max-w-3xl text-base font-medium sm:text-lg">
          Copy-pasteable composition patterns built from ng-brutalism
          primitives. Each pattern shows the rendered output and the template -
          adjust tones, radii, and gaps to fit your context.
        </p>
      </header>
      ...
      <section id="toolbar-row" class="scroll-mt-32">
        ...
        <docs-example [code]="toolbarCode">
          <div
            class="w-full max-w-lg border-3 border-(--nb-border) bg-(--nb-paper) p-4 shadow-[3px_3px_0_0_var(--nb-shadow)]"
          >
            <div nbCluster gap="sm" align="center" justify="between">
              <h2
                nbDisplay
      ...
      <section id="callout-panel" class="scroll-mt-32">
        ...
        <docs-example [code]="calloutPanelCode">
          ...
          >
            ...
            <div nbSection padding="lg">
              <div nbStack gap="lg">
                <div nbCallout tone="yellow" size="xl" shadow="hard">
                  $49/mo
                </div>
                <p nbText>
                  Everything included. No usage limits. Cancel any time.
                </p>
                <button nbButton tone="black" size="lg">
                  Start free trial
                </button>
              </div>
            </div>
